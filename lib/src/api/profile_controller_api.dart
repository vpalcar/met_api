...
class ProfileControllerApi {
  ...
  const ProfileControllerApi(this._dio, this._serializers);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> getUserProfilePhoto({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/profile/profilePhoto';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<String>> uploadDriverLicencePhoto({ 
    ...
    final _path = r'/profile/driverLicencePhoto';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
