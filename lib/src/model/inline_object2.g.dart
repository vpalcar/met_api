...
class _$InlineObject2 extends InlineObject2 {
  ...
  _$InlineObject2._({required this.image}) : super._() {
    BuiltValueNullFieldError.checkNotNull(image, 'InlineObject2', 'image');
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is InlineObject2 && image == other.image;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('InlineObject2')..add('image', image))
        .toString();
  }
}
