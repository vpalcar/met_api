...
part 'opti_user_profile_response.g.dart';
...
abstract class OptiUserProfileResponse implements Built<OptiUserProfileResponse, OptiUserProfileResponseBuilder> {
    ...
    OptiUserProfileResponse._();

    @BuiltValueHook(initializeBuilder: true)
    static void _defaults(OptiUserProfileResponseBuilder b) => b;

    factory OptiUserProfileResponse([void updates(OptiUserProfileResponseBuilder b)]) = _$OptiUserProfileResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<OptiUserProfileResponse> get serializer => _$OptiUserProfileResponseSerializer();
}

class _$OptiUserProfileResponseSerializer implements StructuredSerializer<OptiUserProfileResponse> {
    @override
    final Iterable<Type> types = const [OptiUserProfileResponse, _$OptiUserProfileResponse];

    @override
    final String wireName = r'OptiUserProfileResponse';

    @override
    Iterable<Object?> serialize(Serializers serializers, OptiUserProfileResponse object,
    ...
    @override
    OptiUserProfileResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = OptiUserProfileResponseBuilder();
